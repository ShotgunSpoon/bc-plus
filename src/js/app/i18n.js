...
app.i18n = (() => {
  ...
  const dictionaries = {
    en: {
      ...
      'game.machinegunNotReady': 'Machine gun still firing.',
      'game.noMachinegun': 'No machine gun.',
      ...
      'help.pickupBullets': '<strong>Bullets</strong> — aggressive sawtooth boing. Grants 3–6 bullets. Fire with <kbd>W</kbd> (straight ahead), <kbd>A</kbd> (left), <kbd>S</kbd> (center), <kbd>D</kbd> (right) to nudge the aim.',
      ...
      'help.pickupSpeed': '<strong>Speed burst</strong> — fast revving whir. Press <kbd>G</kbd> to use one. Roughly triples your top speed and acceleration for 3 seconds — perfect for chasing down or ramming someone.',
      ...
      'help.pickupMachinegun': '<strong>Machine gun</strong> (rare) — rapid mechanical rattle. Press <kbd>J</kbd> to spin it up: for 4 seconds you auto-fire bullets every half-second — no ammo needed, half damage each — at whatever\'s in front of you.',
      'help.arcadeHotkeysIntro': 'Item-mode hotkeys (arcade and deathmatch):',
      'help.hotkeyW': '<kbd>W</kbd> — fire a bullet straight ahead',
      'help.hotkeyASD': '<kbd>A</kbd> / <kbd>S</kbd> / <kbd>D</kbd> — fire a bullet (left / center / right nudge)',
      'help.hotkeyE': '<kbd>E</kbd> — sweep all pickups on the field with bearing and range',
      ...
      'help.hotkeyJ': '<kbd>J</kbd> — spin up the machine gun (4 seconds of auto-fire)',
      ...
      'learn.pickupMachinegun': 'Arcade — machine gun pickup (rare)',
      ...
      'learn.machinegunActivated': 'Arcade — machine gun spins up',
      ...
      'ann.machinegunsPart1': '1 machine gun',
      'ann.machinegunsPartN': '{count} machine guns',
      ...
      'ann.machinegunYou1': 'Machine gun! 1 ready.',
      'ann.machinegunYouN': 'Machine gun! {count} ready.',
      'ann.machinegunOther': '{label} picks up a machine gun. Has {count}.',
      'ann.machinegunUseYou': 'Machine gun! Four seconds.',
      'ann.machinegunUseOther': '{label} opens fire with a machine gun!',
    ...
    es: {
      ...
      'game.machinegunNotReady': 'La ametralladora sigue disparando.',
      'game.noMachinegun': 'Sin ametralladora.',
      ...
      'help.pickupBullets': '<strong>Balas</strong> — boing agresivo de sierra. Da entre 3 y 6 balas. Dispara con <kbd>W</kbd> (al frente), <kbd>A</kbd> (izquierda), <kbd>S</kbd> (centro), <kbd>D</kbd> (derecha) para ajustar la puntería.',
      ...
      'help.pickupSpeed': '<strong>Turbo</strong> — zumbido acelerado. Pulsa <kbd>G</kbd> para usar uno. Casi triplica tu velocidad punta y aceleración durante 3 segundos — ideal para perseguir o embestir.',
      ...
      'help.pickupMachinegun': '<strong>Ametralladora</strong> (rara) — traqueteo mecánico rápido. Pulsa <kbd>J</kbd> para activarla: durante 4 segundos disparas balas automáticamente cada medio segundo — sin gastar munición, a mitad de daño — hacia lo que tengas delante.',
      'help.arcadeHotkeysIntro': 'Atajos de los modos con objetos (arcade y combate a muerte):',
      'help.hotkeyW': '<kbd>W</kbd> — dispara una bala al frente',
      'help.hotkeyASD': '<kbd>A</kbd> / <kbd>S</kbd> / <kbd>D</kbd> — disparar una bala (izquierda / centro / derecha)',
      'help.hotkeyE': '<kbd>E</kbd> — barre todos los bonus del campo con rumbo y distancia',
      ...
      'help.hotkeyJ': '<kbd>J</kbd> — activa la ametralladora (4 segundos de disparo automático)',
      ...
      'learn.pickupMachinegun': 'Arcade — recoger ametralladora (rara)',
      ...
      'learn.machinegunActivated': 'Arcade — la ametralladora se activa',
      ...
      'ann.machinegunsPart1': '1 ametralladora',
      'ann.machinegunsPartN': '{count} ametralladoras',
      ...
      'ann.machinegunYou1': '¡Ametralladora! 1 lista.',
      'ann.machinegunYouN': '¡Ametralladora! {count} listas.',
      'ann.machinegunOther': '{label} recoge una ametralladora. Tiene {count}.',
      'ann.machinegunUseYou': '¡Ametralladora! Cuatro segundos.',
      'ann.machinegunUseOther': '¡{label} abre fuego con una ametralladora!',
